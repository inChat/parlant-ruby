...
Gem::Specification.new do |spec|
  ...
  spec.description   = "A Ruby library for interacting with the Parlant API, providing a simple " \
                       "and idiomatic way to manage agents, customers, sessions, and guidelines."
